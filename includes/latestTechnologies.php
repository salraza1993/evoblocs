  ...
  <div class="row">
    <div class="col-12 col-md-12 col-xl-9 p-0">
      <div class="technoligesContainer">
        ...
        <ul class="technoList">
          <li>
            <span class="icon"><?php include('images/angular.svg') ?></span>
            <p>Angular</p>
          </li>
          <li>
            <span class="icon"><?php include('images/node.svg') ?></span>
            <p>NodeJs</p>
          </li>
          <li>
            <span class="icon"><?php include('images/react.svg') ?></span>
            <p>ReactJs</p>
          </li>
          <li>
            <span class="icon"><?php include('images/python.svg') ?></span>
            <p>Python</p>
          </li>
          <li>
            <span class="icon"><?php include('images/golang.svg') ?></span>
            <p>GoLang</p>
          </li>
          <li>
            and much more ...
